package tooltwist.training_charina.productionHelpers;
...
public class HelloCharinaProductionHelper extends WbdProductionHelper
{
	...
	public HelloCharinaProductionHelper(Properties prop)
	{
		super(prop);
	}

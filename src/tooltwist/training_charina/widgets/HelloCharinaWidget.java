package tooltwist.training_charina.widgets;
...
import tooltwist.training_charina.productionHelpers.HelloCharinaProductionHelper;
 ...
 * Hello World Charina
 */
public class HelloCharinaWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "helloCharina_preview.html";
	private static final String SNIPPET_DESIGN = "helloCharina_design.html";
	private static final String SNIPPET_PRODUCTION = "helloCharina_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "helloCharina_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "helloCharina_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HelloCharinaProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(HelloCharinaProductionHelper.class.getName()));
			}
		}
